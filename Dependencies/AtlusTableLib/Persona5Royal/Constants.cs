...
namespace AtlusTableLib.Persona5Royal
{
    public static class Constants
    {
        ...
        public const string TABLE_NAME_ELSAI = "ELSAI";
        public const string TABLE_NAME_ENCOUNT = "ENCOUNT";
        public const string TABLE_NAME_EXIST = "EXIST";
        public const string TABLE_NAME_ITEM = "ITEM";
        public const string TABLE_NAME_NAME = "NAME";
        public const string TABLE_NAME_PERSONA = "PERSONA";
        public const string TABLE_NAME_PLAYER = "PLAYER";
        public const string TABLE_NAME_SKILL = "SKILL";
        public const string TABLE_NAME_TALKINFO = "TALKINFO";
        public const string TABLE_NAME_UNIT = "UNIT";
        public const string TABLE_NAME_VISUAL = "VISUAL";

        public const int MAX_LEVEL = 99;

        public const int ENCOUNTER_COUNT = 1000;
